...
public class dataVars {
    ...
    public static final String HPDimarts = ROOTDOCS + "dimarts.pdf";
    public static final String HPDimecres = ROOTDOCS + "dimecres.pdf";
    public static final String HPDijous = ROOTDOCS + "dijous.pdf";
